...
with open("Out_data_spl.csv","w")as fout:
...
p1 = pd.read_csv('0.01percentile_spl_total_immature.csv', index_col = 0)
p2 = pd.read_csv('0.02percentile_spl_total_immature.csv', index_col = 0)
p5 = pd.read_csv('0.05percentile_spl_total_immature.csv', index_col=0)
p10 = pd.read_csv('0.1percentile_spl_total_immature.csv', index_col =0)
p20 = pd.read_csv('0.2percentile_spl_total_immature.csv', index_col =0)
p30 = pd.read_csv('0.3percentile_spl_total_immature.csv', index_col =0)
p50 = pd.read_csv('0.5percentile_spl_total_immature.csv', index_col =0)
p60 = pd.read_csv('0.6percentile_spl_total_immature.csv', index_col =0)
p70 = pd.read_csv('0.7percentile_spl_total_immature.csv', index_col =0)
p80 = pd.read_csv('0.8percentile_spl_total_immature.csv', index_col =0)
p90 = pd.read_csv('0.9percentile_spl_total_immature.csv', index_col =0)
p100 = pd.read_csv('1percentile_spl_total_immature.csv', index_col =0)


# In[139]:


o = pd.read_csv('Out_data_spl.csv')
...
dup = pd.read_csv('Out_data_spl.csv')
stat=[]
...
o = pd.read_csv('Out_data_spl.csv', index_col =0)
